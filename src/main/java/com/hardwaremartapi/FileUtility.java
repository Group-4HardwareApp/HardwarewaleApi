...
public class FileUtility {
	public String uploadFile(MultipartFile file) throws IOException {
		...
		Storage storage = StorageOptions.newBuilder().setProjectId("hardwarewale-c6f0f")
		...
		BlobId blobId = BlobId.of("hardwarewale-c6f0f.appspot.com", file.getOriginalFilename());
		...
		String imageUrl = "https://firebasestorage.googleapis.com/v0/b/hardwarewale-c6f0f.appspot.com/o/" + convertedFile
